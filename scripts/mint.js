...
async function main() {
  ...
  const TOKEN_ADDRESS = "0xa9ff170b2810d174A4beAcaF535357227729bF0a"; // Replace with deployed token address
  const MINT_TO_ADDRESS = "0xD82c390E4D58BF25F7Af94A6Bee4fCff64936c72"; // Replace with recipient address
  const MINT_AMOUNT = hre.ethers.parseUnits("1000000000", 18); // Amount to mint (1000 tokens)
