...
library TlsnVerificationLib {
    ...
    function verify(
        ...
        // Header Verification
        bytes32[5] memory bodyFieldHashes = _hash_body_fields(headerVerification.body);
        ...
        bytes memory transcriptCommitments = headerVerification.body.transcript_commitments_data;
        assembly {
    ...
    ) internal pure returns (bytes32[5] memory) {
